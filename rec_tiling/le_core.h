...
void le_step_all(le_task *task, int steps);
void le_step_all2(le_task *task, int steps);
void le_step_all3(le_task *task, int steps, int* indX, int* indY, int* indT);

void le_step_rec(le_task *task, int steps, CachedGen& gen);
/*
 * One time step of difference scheme.
